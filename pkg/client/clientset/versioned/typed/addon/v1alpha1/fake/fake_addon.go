...
import (
	...
	v1alpha1 "github.com/keikoproj/addon-manager/apis/addon/v1alpha1"
...
type FakeAddons struct {
	Fake *FakeAddonmgrV1alpha1
	ns   string
}

var addonsResource = schema.GroupVersionResource{Group: "addonmgr.keikoproj.io", Version: "v1alpha1", Resource: "addons"}

var addonsKind = schema.GroupVersionKind{Group: "addonmgr.keikoproj.io", Version: "v1alpha1", Kind: "Addon"}
...
func (c *FakeAddons) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(addonsResource, c.ns, name), &v1alpha1.Addon{})
