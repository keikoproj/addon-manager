...
// +kubebuilder:rbac:groups="",resources=namespaces;clusterroles;configmaps;events;pods;serviceaccounts;services;workflows,verbs=get;list;watch;create;update;patch
